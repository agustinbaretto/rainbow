...
var openFB = (function () {
    ...
    var FB_LOGIN_URL = 'https://www.facebook.com/dialog/oauth',
        ...
        oauthRedirectURL = baseURL + '/rainbow/oauthcallback.html',//'https://www.facebook.com/connect/login_success.html', //baseURL + '/rainbow/oauthcallback.html',

        logoutRedirectURL = baseURL + '/rainbow/logoutcallback.html',//'https://www.facebook.com/connect/login_success.html', //baseURL + '/rainbow/logoutcallback.html',
...
alert(logoutRedirectURL);

    console.log(oauthRedirectURL);
    console.log(logoutRedirectURL);

    document.addEventListener("deviceready", function () {
        runningInCordova = true;alert(runningInCordova);alert(1);
    }, false);
